...
const TextStyle styleHeadList = TextStyle(color: Colors.black, fontFamily: "Roboto", fontSize: 20, fontWeight: FontWeight.w500, letterSpacing: 1, );
const TextStyle styleValueList = TextStyle(color: Colors.black87, fontFamily: "Roboto", fontSize: 28);
...
const TextStyle styleListMainHead = TextStyle(color: Colors.black, fontFamily: "Roboto", fontSize: 28, fontWeight: FontWeight.bold, );
